...
# @param modules [Array] Will be converted to YAML for the modules section of the configuration (see documentation, and above)
...
class filebeat (
  ...
  Array[Hash] $modules                                                = $filebeat::params::modules,
